...
export default function SettingsPage() {
  ...
  const handleSaveGeneral = async (e: React.FormEvent) => {
    ...
    try {
        ...
        // ====================================================
        // MAGICA AQUI: Injeta o novo nome do Pastor na memória 
        // e atualiza o Dashboard instantaneamente!
        // ====================================================
        const newUserName = userRole === 'admin' ? pastor.trim() : userName;

        setChurchData(
            churchId,
            name.trim(),
            userRole || "", 
            newUserName, // <--- Aqui o nome novo sobe para o cabeçalho
            logoUrl, 
            signatureUrl,
            currency
        );
